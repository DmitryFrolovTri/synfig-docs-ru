...
<figure><img src={useBaseUrl('/img/gitbook/image (6).png')} alt="" /><figcaption></figcaption></figure>

Вы увидите диалоговое окно со следующими настройками:

<figure><img src={useBaseUrl('/img/gitbook/image (8).png')} alt="" /><figcaption></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/01_векторизация0001-0720.gif')} alt="" /><figcaption></figcaption></figure>
