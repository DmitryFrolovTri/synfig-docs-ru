...
![](</img/gitbook/layer_distortion_curvewarp_icon (3).png>)
...
<figure><img src={useBaseUrl('/img/gitbook/2024-04-27_15-31.png')} alt="" /><figcaption><p>Графичкское отображение слоя "деформация по кривой"</p></figcaption></figure>

Параметры слоя "Деформация по кривой"

<figure><img src={useBaseUrl('/img/gitbook/2024-04-27_14-55.png')} alt="" /><figcaption><p>Параметры слоя "Деформация по кривой"</p></figcaption></figure>

Данный вид слоя хорошо работает с текстовыми слоями.

<figure><img src={useBaseUrl('/img/gitbook/text (3).gif')} alt="" /><figcaption><p>Пример применения слоя "Деформация по кривой" с текстом</p></figcaption></figure>