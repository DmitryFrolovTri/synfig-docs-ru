...
### <img src={useBaseUrl('/img/gitbook/tool_normal_icon.png')} alt="" data-size="line" /> **Инструмент трансформации**&#x20;
...
:::info
Подробнее о контрольных точках смотрите в разделе “[Параметры слоя](parametry-sloya)”
:::

<figure><img src={useBaseUrl('/img/gitbook/cursor1.gif')} alt="" /><figcaption><p>Использование инструмента трансформации</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/cursor2.gif')} alt="" /><figcaption><p>Использование инструмента трансформации. Перемещение по осям.</p></figcaption></figure>

Выбрав две или более контрольные точки и зажав клавишу **alt**, инструмент трансформации начнет выполнять функцию инструмента [“Масштабирование”](instrumenty#instrument-masshtabirovaniya).

<figure><img src={useBaseUrl('/img/gitbook/cursor3.gif')} alt="" /><figcaption><p>Масштабирование с помощью инструмента трансформации</p></figcaption></figure>

Выбрав две или более контрольные точки и зажав клавишу **ctrl,** инструмент трансформации начнет выполнять функцию инструмента [“Вращение”](instrumenty#instrument-vrasheniya).

<figure><img src={useBaseUrl('/img/gitbook/cursor4.gif')} alt="" /><figcaption><p>Вращение с помощью инструмента трансформации</p></figcaption></figure>

### <img src={useBaseUrl('/img/gitbook/tool_smooth_move_icon.png')} alt="" data-size="line" /> **Инструмент деформации**
...
<figure><img src={useBaseUrl('/img/gitbook/deforma.gif')} alt="" /><figcaption><p>Инструмент деформации</p></figcaption></figure>

Степень влияния на соседние контрольные точки определяется параметром "радиус" в настройках инструмента.

<figure><img src={useBaseUrl('/img/gitbook/deforma2 (1).gif')} alt="" /><figcaption><p>Степень влияния радиуса инструмента деформации</p></figcaption></figure>

### <img src={useBaseUrl('/img/gitbook/tool_scale_icon.png')} alt="" data-size="line" /> Инструмент Масштабирования&#x20;
...
<figure><img src={useBaseUrl('/img/gitbook/size1.gif')} alt="" /><figcaption><p>Изменение масштаба объекта с помощью инструмента "Масштабирование"</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/size2.gif')} alt="" /><figcaption><p>Изменение масштаба объекта с фиксированным соотношением сторон</p></figcaption></figure>

### <img src={useBaseUrl('/img/gitbook/tool_rotate_icon.png')} alt="" data-size="line" /> Инструмент Вращения&#x20;
...
<figure><img src={useBaseUrl('/img/gitbook/spin.gif')} alt="" /><figcaption><p>Вращение объекта </p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/spin2.gif')} alt="" /><figcaption><p>Вращение объекта с функцией масштабирования</p></figcaption></figure>

### <img src={useBaseUrl('/img/gitbook/tool_mirror_icon.png')} alt="" data-size="line" /> Инструмент Отражение
...
<figure><img src={useBaseUrl('/img/gitbook/mirror.gif')} alt="" /><figcaption><p>Отражение контрольных точек по горизонтали</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/mirror2.gif')} alt="" /><figcaption><p>Отражение контрольных точек по вертикали</p></figcaption></figure>

### <img src={useBaseUrl('/img/gitbook/tool_cutout_icon (1) (1).png')} alt="" data-size="line" /> Инструмент Вырезание
...
<figure><img src={useBaseUrl('/img/gitbook/cutout.gif')} alt="" /><figcaption><p>Принцип работы инструмента "Вырезание"</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/cutout.png')} alt="" /><figcaption><p>Инвертирование маски</p></figcaption></figure>

### <img src={useBaseUrl('/img/gitbook/333.png')} alt="" data-size="line" /> Инструмент Коррекция толщины&#x20;
...
<figure><img src={useBaseUrl('/img/gitbook/thickness.gif')} alt="" /><figcaption><p>Коррекция толщины контура</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/2024-03-25_15-30.png')} alt="" /><figcaption><p>Настройки инструмента "Коррекция толщины"</p></figcaption></figure>

## Инструменты создания объектов

### <img src={useBaseUrl('/img/gitbook/tool_circle_icon.png')} alt="" data-size="line" /><img src={useBaseUrl('/img/gitbook/tool_rectangle_icon.png')} alt="" data-size="line" /><img src={useBaseUrl('/img/gitbook/tool_star_icon.png')} alt="" data-size="line" /><img src={useBaseUrl('/img/gitbook/tool_polyline_icon.png')} alt="" data-size="line" /> Окружность, прямоугольник, астериск, многоугольник&#x20;
...
<figure><img src={useBaseUrl('/img/gitbook/shapes.gif')} alt="" /><figcaption><p>Окружность, Прямоугольник, Астериск, Многоугольник</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/toolsparameter.png')} alt="" /><figcaption><p>Настройки инструмента "Окружность"</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/2 (1) (1) (1).png')} alt="" /><figcaption><p>Настройки инструмента "Окружность"</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/3 (2) (1).png')} alt="" /><figcaption><p>Настройки инструмента "Прямоугольник"</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/5 (1) (1).png')} alt="" /><figcaption><p>Настройки инструмента "Астериск"</p></figcaption></figure>

### <img src={useBaseUrl('/img/gitbook/tool_text_icon.png')} alt="" data-size="line" /> Текст&#x20;
...
<figure><img src={useBaseUrl('/img/gitbook/text (2).gif')} alt="" /><figcaption><p>Инструмент "Текст"</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/textmor1.gif')} alt="" /><figcaption><p>_Однострочный редактор текста_</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/textmor2.gif')} alt="" /><figcaption><p>Многос_трочный редактор текста_</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/font1.gif')} alt="" /><figcaption><p>Использование системных шрифтов</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/font2 (2).gif')} alt="" /><figcaption><p>Использование файлов шрифтов</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/font4.gif')} alt="" /><figcaption><p>Использование локальных шрифтов</p></figcaption></figure>

### <img src={useBaseUrl('/img/gitbook/tool_spline_icon.png')} alt="" data-size="line" /> **Инструмент Кривые**
...
<figure><img src={useBaseUrl('/img/gitbook/spline (3).gif')} alt="" /><figcaption><p>Использование инструмента "Кривые"</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/context2.png')} alt="" /><figcaption><p>**Контекстное меню кривой**</p></figcaption></figure>

**Контекстное меню вершины:**

<figure><img src={useBaseUrl('/img/gitbook/contextmenu1 (1).png')} alt="" /><figcaption><p>**Контекстное меню вершины**</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/splineangle.gif')} alt="" /><figcaption><p>Развязанный угол касательных</p></figcaption></figure>

<figure><img src={useBaseUrl('/img/gitbook/splineradius.gif')} alt="" /><figcaption><p>Развязанный радиус касательных</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/deletepoints.gif')} alt="" /><figcaption><p>Удаление вершин</p></figcaption></figure>

### <img src={useBaseUrl('/img/gitbook/tool_sketch_icon.png')} alt="" data-size="line" /> **Инструмент Рисование**
...
### <img src={useBaseUrl('/img/gitbook/layer_gradient_linear_icon.png')} alt="" data-size="line" /> Инструмент Градиент&#x20;
...
<figure><img src={useBaseUrl('/img/gitbook/linear.png')} alt="" /><figcaption><p>Линейный градиент</p></figcaption></figure>

* Радиальный

<figure><img src={useBaseUrl('/img/gitbook/sphere.png')} alt="" /><figcaption><p>Радиальный градиент</p></figcaption></figure>

* Конический

<figure><img src={useBaseUrl('/img/gitbook/cone.png')} alt="" /><figcaption><p>Конический градиент</p></figcaption></figure>

* Спиральный

<figure><img src={useBaseUrl('/img/gitbook/spiral.png')} alt="" /><figcaption><p>Спиральный градиент</p></figcaption></figure>

## Инструменты утилиты

### <img src={useBaseUrl('/img/gitbook/tool_fill_icon.png')} alt="" data-size="line" /> **Сплошная заливка**
...
<figure><img src={useBaseUrl('/img/gitbook/fill.gif')} alt="" /><figcaption><p>Сплошная заливка</p></figcaption></figure>

### <img src={useBaseUrl('/img/gitbook/tool_eyedrop_icon.png')} alt="" data-size="line" /> **Инструмент Пипетка**
...
<figure><img src={useBaseUrl('/img/gitbook/eye (1).gif')} alt="" /><figcaption><p>Пипетка</p></figcaption></figure>