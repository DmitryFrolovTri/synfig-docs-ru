...
<figure><img src={useBaseUrl('/assets/lh7-us.googleusercontent.com_gIXPyvObMZbdeGc6snvZSeWfh_Dnau5hRL-aU6OoWdYJXH75qG5pnq1v402PyWsN4ICMCcEUIKxxnPMGnt0Rw-pQqESCAfZAxzbX2bY5bGw3wEfbhbThSucbaEHdGQ2WKl_ITCj5UIm8fvH-TihKKSU_dd3030395f1c.png')} alt="" /><figcaption></figcaption></figure>

На примере ниже фильтр “Размывание” действует на все окружности, что находятся под ним.

<figure><img src={useBaseUrl('/assets/lh7-us.googleusercontent.com_DtcyW9rWvufBxgdzI8TPvQMzPYpqyk5s4u7n8pjYRq_Xt6V5u-aWSqGEUL5QOFlgC5KzjlfEXXk1wie9Gx9e915mXs0k7Hsxxi8PBgtPz0ctXlk1dRljUxUJabUMIVeMjo1AjK_UHSF508sso-0vH1M_c5b8667d7b28.png')} alt="" /><figcaption></figcaption></figure>

Группируем одну окружность и фильтр. Теперь фильтр действует только на ту окружность, что находится в группе вместе с ним.

<figure><img src={useBaseUrl('/assets/lh7-us.googleusercontent.com_n7ulnbwHOwAXQXjlFL9ws3Bsr1K0zY9mxDukCAOqJN1ggHVQlGgohtGOW0mlj-EXMelUsijSzOrEmDPM3hmMQ3QO3oLLtuU4CstsPgZr-5_5D3DpE_FoVs3Sp-0pL0SPReu0YybNYGvwclPbL1VEbuw_77bd5bf39d45.png')} alt="" /><figcaption></figcaption></figure>