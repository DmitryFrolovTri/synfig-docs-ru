...
<img src={useBaseUrl('/assets/lh7-us.googleusercontent.com_wKQKyOMsnDNdB-ioo_xKKYVnBMoScs36FiayludC5UezLgE_66u7WbGjChg1iTgShr3OLJuaHNxqm4XOm65Ymkjq1NTUkqxAuNwW9RN62gdLFR8Ib0Y-61rBhhMavSh3_5CWw9vSZBXaNXlNl7upLWE_5aedae332cbb.png')} alt="" data-size="line" />**Фиксаторы** — это графические элементы, отображаемые на шкале кадров. Они автоматически создаются при изменении значений параметров объекта (слоя) в режиме анимации. Для каждого параметра создается отдельный фиксатор.

<figure><img src={useBaseUrl('/img/gitbook/2024-04-03_16-29.png')} alt="" /><figcaption><p>Графическое отображение фиксаторов</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/waypointsmove.gif')} alt="" /><figcaption><p>Перемещение фиксаторов</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/assets/lh7-us.googleusercontent.com_3NiGs3lqAqSA721hwpYdKpWdXXFBYwqUbzQJONoke4ZZqvIUnU3CakLZXpsIdJpRNC2tHf4knkEO5t4XcyntJ6TGjHhBbKMUlilBviHtC9ZZWGvAbSuqr5PQIfUZ1QD3ogD0MI4lUY0ANnOG3zAAv68_edfdd3c3005e.png')} alt="" /><figcaption><p>Действия с фиксаторами</p></figcaption></figure>

В самом верху меню находятся команды, которые позволяют связывать значение фиксатора с другими параметрами (или другими фиксаторами). Подробнее об этом можно прочитать в разделе [“Связывание параметров”.](../svyazyvanie-dannykh/svyazyvanie-parametrov)
...
<figure><img src={useBaseUrl('/assets/lh7-us.googleusercontent.com_OmLJsY0xmNwvokrXh1-ktw_kOPIy5KxOQisCjlBSMC4-LYS1RuMhcEJ3suIVDVMQOPaMrNYyK-KIWYKZOp_Cb16qOkrs7yFDRkw2jNVdCbRt3Fhnkva1Am0k35EAJhE1nQlL2k3Ne7I4_VDfh_9v0xg_80964de436ff.png')} alt="" /><figcaption><p>Фиксаторы с разной интерполяцией</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/интерполяция.gif')} alt="" /><figcaption><p>Разница типов интерполяции при одинаковых параметрах</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/assets/lh7-us.googleusercontent.com_YGO5RE03H0rrmctpAu2cYa76xGzHR-kBvrYpTpgIDnBWey7QG4vT-Q1HbKkOZiZ5C6vWsS93eH2vmaB_p-w9lrIaZ2QW8W9JpiCBTZaeR3LqGqFa7t12XrEK1cmrV0Woh_Xu3GySJCxo8AtHChe0sBE_16a80fa880d3.png')} alt="" /><figcaption><p>Окно с выбором интерполяции</p></figcaption></figure>
...
* <img src={useBaseUrl('/assets/lh7-us.googleusercontent.com_7BHqXAiCFdTqoZaWK_LIuEkXauqBvkRV_G247M3BDG1dzUpL2AI8dR7PFDOr0xNcOYdEhZ-XcjnWbMjC8WtWZ8ETuGDyUpFTDgeV9FnzKzkEBWTj0OQA2pYOmpyRsS8GFvD4C-wLz42IOZIKRajPpIQ_9514e3cf555b.png')} alt="" data-size="line" /> - Сгладить
* &#x20;<img src={useBaseUrl('/assets/lh7-us.googleusercontent.com_7dt7VZTkNTvLo9a-TqkvGIkihI9CNUEGijZgh-Fe8QQ63OM0N1OoTSbJxAN-x30O5LuPxiSgYRE88z63pQETLze2Ns4GwOdsyQ6HRs_FhGpm0MbgcSfG5hDmfK4QU0S601gPQiKjEIg_cDCNCeNtX3s_e063f37c62b5.png')} alt="" data-size="line" /> - TCB (Ти-Си-Би)
* &#x20;<img src={useBaseUrl('/assets/lh7-us.googleusercontent.com_Js82sCH0xKtdY0oB6Z0bwuGmltGvTvxtlI8GKaTLMXNrsY55-rjJDFnrozBsLB1Mg7Y3Y3oe1Fa98GGQ31blQzkJDjKAX4Wk8WNdZgxcUYF0VfdFsorwYYJSsxY7gs8FoO83qo8ewWPFr7_M-mdpdUo_6d4cd76dc520.png')} alt="" data-size="line" /> - Константа
* &#x20;<img src={useBaseUrl('/assets/lh7-us.googleusercontent.com_05tT-nUBRDV5p1a6hc9mVv5WQK0ghA9RDssyTYZ_bG9rRlRPhXCJyVP5jRdqIs-bLa1DcVnq7BU0Fy79eRo7OeMUEV9RkdoNEk_Bb0ebBuCfnSGV4dxI63b775bs3Mwx0-vig4hEPRQCNLQ2_jiHK_I_ddfd49778c01.png')} alt="" data-size="line" /> - Плавный вход/выход
* <img src={useBaseUrl('/assets/lh7-us.googleusercontent.com_NfVSSE2cLj9tLvvauNxsFgpNFP36mNgYqXGsTiNANAqTb22Wqj6mHX9f13I6HgWZgQ-c_4xW-AAcIrV9EVtxr3otCOQHhU0JzdTjAl29rwJJoJXEgrneTb2qTuiTPv7osn36XJULhLLZUHsdoyOm9qs_56cc72798c4c.png')} alt="" data-size="line" /> - Линейная
...
<figure><img src={useBaseUrl('/img/gitbook/линейная.gif')} alt="" /><figcaption><p>Демонстрация "линейной" интерполяции</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/гладкая.gif')} alt="" /><figcaption><p>Демонстрация интерполяции "Сгладить"</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/TCB.gif')} alt="" /><figcaption><p>Демонстрация интерполяции "TCB"</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/assets/lh7-us.googleusercontent.com_VlXQPUIoxmuN4BlpGtSAyo8uR1_qhrd9gVNF9ReGNbx_to3X3qgF507VxoT4eKsUqatDuXQTe7JSbIKTrxRzIlIx76Jtt6JKN8iwm2wA0dZahoVoyeus2ml6D-xByHZs5UU7n_CvlO_2ilJSsUEpraA_48059259c5be.png')} alt="" /><figcaption><p>Настройки интерполяции "TCB"</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/interpolation2.gif')} alt="" /><figcaption><p>Демонастрация настроек интерполяции TCB</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/константа.gif')} alt="" /><figcaption><p>Демонстрация интерполяции "константа"</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/плавный.gif')} alt="" /><figcaption><p>Демонстрация интерполяции "Плавный вход/выход"</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/assets/lh7-us.googleusercontent.com_5bwS_zW18cLFPafYpuptjBliLYzHtdDjyN9WhNie2lj22q8ODQGVMjtS25oPu6_MbqLKryG3jBh4Hn-qvgAFd75DWWwnDWq7kYkQmorODhrYeyD6Xo0WXZ1TVRFfetUTce_u67k7ZOIbG9IKEH1tZ8w_71549a8df3e6.png')} alt="" /><figcaption><p>Окно с выбором интерполяции по умолчанию</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/assets/lh7-us.googleusercontent.com_SnpNOG8HeRNyBRhJNy310YqlnzcWT0rJY7nfwkhIoVm8W6Zx0TFjZWuQHAkoc0cVMyflRrWTomiAcCx_Hd8FGrDOGQgCv5y8Z5bJbNmzmFK3JhlXjyLWaTYTxjGH9_TFbUe2k6_Z73DRoYgs7bKChkw_3bfd53bf1466.png')} alt="" /><figcaption><p>Окно с выбором интерполяции на "вход"</p></figcaption></figure>

* Интерполяция выхода определяет, как параметр изменяется в моменты после достижения фиксатора.

<figure><img src={useBaseUrl('/assets/lh7-us.googleusercontent.com_zeWX71T9SPB9UG08yPY_5BCCaD6HfJPJxcILEpvcBGSZsjGSjkNoTSpEbpbCT90a4OpR00vv7kd1pEyVA-OKr5oRxATx7ieO74GMhNFtfpiK-z65Dt84r93jCj3xjGrDNoFTpsbg8gJSX0nyFNbZW_w_7733dbcd0a04.png')} alt="" /><figcaption><p>Окно с выбором интерполяции на "выход"</p></figcaption></figure>

Наглядно это видно на графиках анимации, которые вы можете включить сверху шкалы кадров.

<figure><img src={useBaseUrl('/img/gitbook/linearandsmooth2.png')} alt="" /><figcaption><p>Графики анимации</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/assets/lh7-us.googleusercontent.com_mdZs0xTpym9_tW-Z9lwJXN_0sPuyJoZMKPLkRPpMPyFYV2j4c_KvOpjb_Lu8V2q7796lFU3K6zdY-VRFkr-sSR0jsEY3vLwbYcDoS9fAtEyBbnEjKbzpgEftDDUXmUbQOqkA3JJaJU-nJ08L5-Lnf5A_139dc5dcc0b0.png')} alt="" /><figcaption><p>Варианты использования разных интерполяций на входе и выходе.</p></figcaption></figure>

<img src={useBaseUrl('/assets/lh7-us.googleusercontent.com_RQ8Sb3Nes5E_HqvjjoTjEvk4N_CUzJJ9MHDbqyv1COQ4GxSGu4B57RthykuraoEhDL7tsi6P-3q8-GRUcogMyVPHhAn2RBB7tEzgNGiQLpyGXktCJGiSL_RXbASuYBuZ1FomIqRVb3VhDXha37u2SDk_1bca42e899d7.png')} alt="" data-size="line" />- Неопределенный фиксатор (серый) - используется, когда у одного объекта на шкале кадров записано несколько фиксаторов для разных вершин с разными типами интерполяции.&#x20;

<figure><img src={useBaseUrl('/assets/lh7-us.googleusercontent.com_33T8Q_70N4xMqPv0LYleh-_HCo4lGPBjTACl-VGoKHX_k0gGqEACGp6hyEpy98QpQkx6IvZ-pja5mStucH0LLW85AHk9_EJuFpIHF-NHA5U5Bo1x9W7UvmkBo0mohIVM20voKPcG5ivE2YZ56TFOZ1E_d8c142fbc49a.png')} alt="" /><figcaption><p>Неопределенный фиксатор на шкале кадров</p></figcaption></figure>

Если у фиксаторов используется одна интерполяция, будет использоваться символ текущей интерполяции.&#x20;

<figure><img src={useBaseUrl('/assets/lh7-us.googleusercontent.com_xNpl_nEw39Dsjvb83akV9rIsC1lW3kjDikup8Y6VrS15w3hRuPvUtjtUpHi0DhF4CWUtpxXteTzgbCpukMltzTJMSawoGMVaiVYdH5gKZOMauvUokOJkQkQrGXJTvUkhD1tNe1TDCeinPSLCsce6cpg_ec7f68011e55.png')} alt="" /><figcaption><p>Разная интерполяция для вершин одного объекта</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/assets/lh7-us.googleusercontent.com_SKtK923ASc288i7Go8_VMDBWxAUiKnufzQLY_SpByumciVPH9vddSXmJTCu0MYChT4XlQ1gKD2gRge4z-lAqrKnPRLILMaSJHI1z_zpWzDKQFzBZdE1i6wjg2KikeLlZPSbQAc3veHyHYD1emHazvQo_5a9c7d38f26c.png')} alt="" /><figcaption></figcaption></figure>

<figure><img src={useBaseUrl('/assets/lh7-us.googleusercontent.com_a1S9623B3ZiY8W5Un9cJ6r2Ac9BBYTa1CalreLgqXcWc-s6GwILXy0aOd_Uer5Ho1ZsBOacZeXMisG3HImh6kGTplOmEaPV1ReexwR8AN8PUbGdeGT8oDUB0el02vLFUiAEONSGE_vEj2OFWsm9ULzo_0cee84f34409.gif')} alt="" /><figcaption><p>Разная интерполяция для вершин одного объекта</p></figcaption></figure>