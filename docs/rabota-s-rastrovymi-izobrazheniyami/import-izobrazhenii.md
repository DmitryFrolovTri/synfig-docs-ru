...
<figure><img src={useBaseUrl('/img/gitbook/import_izob (1).gif')} alt="" /><figcaption><p>Импорт изображения</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/import_izob_1.gif')} alt="" /><figcaption><p>Импорт изображения</p></figcaption></figure>