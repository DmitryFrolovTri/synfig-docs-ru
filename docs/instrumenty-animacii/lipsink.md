...
<figure><img src={useBaseUrl('/img/gitbook/lips-fullpng (1).png')} alt="" /><figcaption><p>Список фонем</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/lips-short.png')} alt="" /><figcaption><p>Сокращенный список фонем</p></figcaption></figure>
...
Первое - нужно объединить фонемы в [слой-переключатель](sloi-pereklyuchatel).

:::info
Как объединять слои в слой-переключатель смотрите в разделе "[Слой-переключатель](sloi-pereklyuchatel)".
:::
...
<figure><img src={useBaseUrl('/img/gitbook/sound-import (1).png')} alt="" /><figcaption><p>Аудиофайл на панели слоёв</p></figcaption></figure>
...
## <img src={useBaseUrl('/img/gitbook/papagayo-ng.ico')} alt="" data-size="line" />Липсинк с помощью Papagayo-NG

Первое, что нужно сделать - это установить программу Papagayo-NG. Скачать её можно тут (вставить ссылку) (рис. 4).

<figure><img src={useBaseUrl('/img/gitbook/papag.png')} alt="" /><figcaption><p>Стартовое окно Papagayo-NG</p></figcaption></figure>

### Интерфейс

<figure><img src={useBaseUrl('/img/gitbook/papaginterface3 (1).png')} alt="" /><figcaption><p>Интерфейс Papagayo-NG</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/papagayoimport.gif')} alt="" /><figcaption><p>Импорт аудиофайла в Papagayo-NG</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/papagayostartend.gif')} alt="" /><figcaption><p>Задаём начало и конец фразы</p></figcaption></figure>

Таким же образом можно обозначить начало и конец слов с помощью оранжевых блоков.

<figure><img src={useBaseUrl('/img/gitbook/papagayostartend2.gif')} alt="" /><figcaption><p>Задаём начало и конец слова</p></figcaption></figure>

А также можно двигать отдельно стоящие фонемы для более точной настройки липсинка.

<figure><img src={useBaseUrl('/img/gitbook/phoneme.gif')} alt="" /><figcaption><p>Перемещение фонем</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/papagdifmouth.gif')} alt="" /><figcaption><p>Демонстрация липсинка</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/pgogroup.png')} alt="" /><figcaption><p>Файл из Papagayo-NG импортированый в Synfig</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/papagayosynf.gif')} alt="" /><figcaption><p>Перемещение фонем в группы переключателя слоёв</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/resultpapag.gif')} alt="" /><figcaption><p>Результат липсинка через Papagayo-NG</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/beforeafter.gif')} alt="" /><figcaption><p>Сравнение липсинка до и после сокращения фонем</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/beforeafter2.gif')} alt="" /><figcaption><p>Сравнение липсинка до и после сокращения фонем</p></figcaption></figure>
