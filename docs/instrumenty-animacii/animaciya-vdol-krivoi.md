...
<figure><img src={useBaseUrl('/img/gitbook/Synfig Animation 1.gif')} alt="" /><figcaption><p>Анимация вдоль кривой</p></figcaption></figure>

При этом, траекторию движения (кривую) можно скрыть, выключив слой на панели слоёв.

<figure><img src={useBaseUrl('/img/gitbook/Synfig Animation 2.gif')} alt="" /><figcaption><p>Анимация вдоль кривой без отображения пути.</p></figcaption></figure>
...
Создаем произвольный объект. Для наглядности создадим стрелку с помощью инструмента [“кривые”,](../osnovnye-principy/instrumenty#instrument-krivye) так мы будем видеть направление движения.

<figure><img src={useBaseUrl('/img/gitbook/create.gif')} alt="" /><figcaption><p>Создание объекта</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/movecursor.gif')} alt="" /><figcaption><p>Смещение объекта для выставления его центра</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/group.gif')} alt="" /><figcaption><p>Группирование слоев</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/way.gif')} alt="" /><figcaption><p>Построение кривой</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/link.gif')} alt="" /><figcaption><p>Привязка объекта к кривой</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/anim.gif')} alt="" /><figcaption><p>Анимирование вдоль кривой</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/revers-nospeed.gif')} alt="" /><figcaption><p>Демонстрация работы анимации вдоль кривой</p></figcaption></figure>
...
<figure><img src={useBaseUrl('/img/gitbook/turn.gif')} alt="" /><figcaption><p>Анимация вдоль кривой</p></figcaption></figure>
